...
def run_pipeline():
    ...
    dfs['table1'] = pd.read_csv(r'_projects\demo_project\data_sources\demo_data_source\data.csv')  #sq_action:Create table table1 from demo_data_source
    dfs['table2'] = pd.read_csv(r'_projects\demo_project\data_sources\demo_data_source\data.csv')  #sq_action:Create table table2 from demo_data_source
